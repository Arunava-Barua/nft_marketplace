...
import { Banner, CreatorCard, NFTCard, Search, Loader } from '../components';
    ...
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-full minmd:w-4/5">
        ...
        {!isLoading && !nfts.length ? (
          <h1 className="font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 xs:ml-0 text-center">Oops !! Seems like there is no NFTs for sale 😭. Click the create button to list the first NFT🎊</h1>
        ) : isLoading ? (<Loader />) : (
          <>
            <div>
            ...
            <div className="mt-10">
              <div className="flexBetween mx-4 xs:mx-0 minlg:mx-8 sm:flex-col sm:items-start">
                ...
                <div className="flex-2 sm:w-full flex flex-row sm:flex-col">
                  <Search activeSelect={activeSelect} setActiveSelect={setActiveSelect} handleSearch={onHandleSearch} clearSearch={onClearSearch} />
