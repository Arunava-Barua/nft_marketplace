      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full flex flex-column">
            <p className="font-poppins dark:text-white text-nft-black-1 font-medium text-base m-2 border-b-2 dark:border-cyan-400 border-nft-gray-1 cursor-pointer">Details</p>
            <p className="font-poppins dark:text-white text-nft-black-1 font-medium text-base m-2 dark:border-nft-gray-1 border-nft-gray-1 cursor-pointer">History</p>
            <p className="font-poppins dark:text-white text-nft-black-1 font-medium text-base m-2 dark:border-nft-gray-1 border-nft-gray-1 cursor-pointer">Information</p>
          </div>
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase()
            ? (
              <p className="font-poppins dark:text-white text-nft-black-1 font-normal text-base border border-cyan-400 p-2">
        ...
        <Modal
          ...
          footer={(
            <div className="flex flex-row sm:flex-col">
              ...
              <Button
                btnName="Cancel"
                classStyles="rounded-xl sm:mr-0"
        ...
        <Modal
          ...
          body={(
            <div className="flexCenter flex-col text-center" onClick={() => setSuccessModal(false)}>
              ...
              <p className="font-poppins dark:text-white text-nft-black-1 text-m minlg:text-xl font-normal mt-10">🎉 You have successfully purchased <span className="font-semibold text-cyan-400">{nft.name}</span> from <span className="font-semibold text-cyan-400">{shortenAddress(nft.seller)}</span> 🎉 </p>
            </div>
          )}
          footer={(
